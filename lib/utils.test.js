...
describe('inProduction', () => {
  ...
  it('returns false NODE_ENV not set', () => {
    expect(utils.inProduction()).toBe(false)
  })

  it('returns false NODE_ENV is empty', () => {
    process.env.NODE_ENV = ''
    expect(utils.inProduction()).toBe(false)
  })

  it('returns false if NODE_ENV is development', () => {
  ...
  it('returns true if NODE_ENV is production', () => {
    ...
    expect(utils.inProduction()).toBe(true)
  })

  it('returns true if running on Glitch and NODE_ENV not set', () => {
    process.env.PROJECT_REMIX_CHAIN = '["dead-beef"]'
    expect(utils.inProduction()).toBe(true)
  })
})
